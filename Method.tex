...
One-directional GRU + i-t AVG  & 1.3         & 10.8        & 20.1       & 3.5        & 10.1       & 16.8      \\ \hline
\end{tabular}
...
i-t usually surpasses t-i on both pooling methods.


The best result of model is often achieved by i-t AVG and i-t LSE, 1.2 on sentence retrieval (R@5) and 1.0 on image retrieval (R@5) relatively on Chinese artwork dataset; 3.7 on sentence retrieval (R@5) and 3.8 on image retrieval (R@5) relatively on Chinese artwork dataset.
