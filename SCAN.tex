...
%% Shurong: remove the motivation part or a brief sentence saying that SCAN is prove very effective in image-text alignment. In this part, it's better the images from the original paper can be replaced by your own. (Move the evaluation metrics in chapter 4 introduction to this chapter.) Give some insights into the bad examples about why the model does not work for them
\section{Motivation}
