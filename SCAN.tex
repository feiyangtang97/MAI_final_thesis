...
%% SHURONG: we didn't compare this method with others on our datasets, no?
Followed by discussing how it surpasses other models and why we choose to investigate it to solve the problem later in the task of fine-grained cross-modal retrieval for artworks.
